...
void	fractal_init(t_fractal *fractal)
{
	...
	if (NULL == fractal->mlx_connection)
		malloc_error();
	fractal->mlx_window = mlx_new_window(fractal->mlx_connection, fractal->WIDTH, fractal->HEIGHT,
			fractal->name);
	...
	fractal->img.img_ptr = mlx_new_image(fractal->mlx_connection, fractal->WIDTH,fractal->HEIGHT);
